...
public class AutomaticPixelatorScreenBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AutomaticPixelatorScreenBlockEntity(BlockPos position, BlockState state) {
		super(PixelatorModBlockEntities.AUTOMATIC_PIXELATOR_SCREEN.get(), position, state);
	}
