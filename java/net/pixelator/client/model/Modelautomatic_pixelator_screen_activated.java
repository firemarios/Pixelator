...
public class Modelautomatic_pixelator_screen_activated<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("pixelator", "modelautomatic_pixelator_screen_activated"), "main");
