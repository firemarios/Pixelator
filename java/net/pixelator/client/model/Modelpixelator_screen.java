...
public class Modelpixelator_screen<T extends Entity> extends EntityModel<T> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		Screen.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
		MainBoard.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
		Lever.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
	}
}