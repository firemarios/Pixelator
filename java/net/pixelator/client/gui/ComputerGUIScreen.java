...
public class ComputerGUIScreen extends AbstractContainerScreen<ComputerGUIMenu> implements PixelatorModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("pixelator:textures/screens/computer_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("pixelator:textures/screens/title_island.png"), this.leftPos + 9, this.topPos + -5, 0, 0, 120, 15, 120, 15);
	...
	public void init() {
		...
		imagebutton_camera_box = new ImageButton(this.leftPos + 7, this.topPos + 13, 70, 40, 0, 0, 40, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_camera_box.png"), 70, 80, e -> {
			int x = ComputerGUIScreen.this.x;
			int y = ComputerGUIScreen.this.y;
			if (ComputerCam1VProcedure.execute(entity)) {
		...
		imagebutton_camera_box1 = new ImageButton(this.leftPos + 97, this.topPos + 13, 70, 40, 0, 0, 40, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_camera_box1.png"), 70, 80, e -> {
			int x = ComputerGUIScreen.this.x;
			int y = ComputerGUIScreen.this.y;
			if (ComputerCam2VProcedure.execute(entity)) {
		...
		imagebutton_camera_box2 = new ImageButton(this.leftPos + 7, this.topPos + 67, 70, 40, 0, 0, 40, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_camera_box2.png"), 70, 80, e -> {
			int x = ComputerGUIScreen.this.x;
			int y = ComputerGUIScreen.this.y;
			if (ComputerCam3VProcedure.execute(entity)) {
		...
		imagebutton_camera_box3 = new ImageButton(this.leftPos + 97, this.topPos + 67, 70, 40, 0, 0, 40, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_camera_box3.png"), 70, 80, e -> {
			int x = ComputerGUIScreen.this.x;
			int y = ComputerGUIScreen.this.y;
			if (ComputerCam4VProcedure.execute(entity)) {
		...
		imagebutton_pixelator_camera_left = new ImageButton(this.leftPos + 34, this.topPos + 23, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_pixelator_camera_left.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_pixelator_camera_left);
		imagebutton_pixelator_camera_left1 = new ImageButton(this.leftPos + 125, this.topPos + 24, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_pixelator_camera_left1.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_pixelator_camera_left1);
		imagebutton_pixelator_camera_left2 = new ImageButton(this.leftPos + 35, this.topPos + 78, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_pixelator_camera_left2.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_pixelator_camera_left2);
		imagebutton_pixelator_camera_left3 = new ImageButton(this.leftPos + 125, this.topPos + 79, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_pixelator_camera_left3.png"), 16, 32, e -> {
		});
