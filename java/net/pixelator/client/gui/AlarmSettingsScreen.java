...
public class AlarmSettingsScreen extends AbstractContainerScreen<AlarmSettingsMenu> implements PixelatorModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("pixelator:textures/screens/alarm_settings.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("pixelator:textures/screens/title_island.png"), this.leftPos + 6, this.topPos + -7, 0, 0, 120, 15, 120, 15);
	...
	public void init() {
		super.init();
		imagebutton_off = new ImageButton(this.leftPos + 6, this.topPos + 29, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_off.png"), 72, 40, e -> {
		...
		imagebutton_off1 = new ImageButton(this.leftPos + 6, this.topPos + 56, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_off1.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
			if (true) {
		...
		imagebutton_off2 = new ImageButton(this.leftPos + 6, this.topPos + 110, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_off2.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
			if (true) {
		...
		imagebutton_off3 = new ImageButton(this.leftPos + 6, this.topPos + 137, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_off3.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
			if (true) {
		...
		imagebutton_on = new ImageButton(this.leftPos + 6, this.topPos + 29, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_on.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
		...
		imagebutton_on1 = new ImageButton(this.leftPos + 6, this.topPos + 56, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_on1.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
		...
		imagebutton_on2 = new ImageButton(this.leftPos + 6, this.topPos + 110, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_on2.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
		...
		imagebutton_on3 = new ImageButton(this.leftPos + 6, this.topPos + 137, 72, 20, 0, 0, 20, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_on3.png"), 72, 40, e -> {
			int x = AlarmSettingsScreen.this.x;
			int y = AlarmSettingsScreen.this.y;
		...
		imagebutton_x = new ImageButton(this.leftPos + 34, this.topPos + 31, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_x.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_x);
		imagebutton_x1 = new ImageButton(this.leftPos + 34, this.topPos + 58, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_x1.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_x1);
		imagebutton_x2 = new ImageButton(this.leftPos + 34, this.topPos + 112, 16, 16, 0, 0, 16, ResourceLocation.parse("pixelator:textures/screens/atlas/imagebutton_x2.png"), 16, 32, e -> {
		});
