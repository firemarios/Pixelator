...
public class ComputerLoginScreen extends AbstractContainerScreen<ComputerLoginMenu> implements PixelatorModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = new ResourceLocation("pixelator:textures/screens/computer_login.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(IMAGE_0, this.leftPos + 11, this.topPos + -5, 0, 0, 120, 15, 120, 15);
		guiGraphics.blit(IMAGE_1, this.leftPos + 146, this.topPos + 75, 0, 0, 12, 19, 12, 19);
	...
	public void init() {
		super.init();
		computerLoginUsername = new EditBox(this.font, this.leftPos + 15, this.topPos + 20, 120, 20, Component.translatable("gui.pixelator.computer_login.computerLoginUsername"));
		...
		computerLoginPassword = new EditBox(this.font, this.leftPos + 15, this.topPos + 50, 120, 20, Component.translatable("gui.pixelator.computer_login.computerLoginPassword"));
		...
		imagebutton_done_btn = new ImageButton(this.leftPos + 125, this.topPos + 75, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_done_btn.png"), 18, 36, e -> {
