...
public class CameraViewPropertiesScreen extends AbstractContainerScreen<CameraViewPropertiesMenu> implements PixelatorModScreens.ScreenAccessor {
	...
	public void init() {
		super.init();
		imagebutton_night_vision_disabled = new ImageButton(this.leftPos + 6, this.topPos + 7, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_night_vision_disabled.png"), 18, 36, e -> {
		...
		imagebutton_night_vision = new ImageButton(this.leftPos + 6, this.topPos + 7, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_night_vision.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
		...
		imagebutton_x = new ImageButton(this.leftPos + 8, this.topPos + 9, 16, 16, 0, 0, 16, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_x.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_x);
		imagebutton_glowing_disabled = new ImageButton(this.leftPos + 6, this.topPos + 25, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_glowing_disabled.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
			if (true) {
		...
		imagebutton_glowing = new ImageButton(this.leftPos + 6, this.topPos + 25, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_glowing.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
		...
		imagebutton_x1 = new ImageButton(this.leftPos + 7, this.topPos + 26, 16, 16, 0, 0, 16, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_x1.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_x1);
		imagebutton_alarm_disabled = new ImageButton(this.leftPos + 6, this.topPos + 43, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_alarm_disabled.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
			if (true) {
		...
		imagebutton_alarm_disabled1 = new ImageButton(this.leftPos + 6, this.topPos + 43, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_alarm_disabled1.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
		...
		imagebutton_x2 = new ImageButton(this.leftPos + 7, this.topPos + 44, 16, 16, 0, 0, 16, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_x2.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_x2);
		imagebutton_alarm_manual = new ImageButton(this.leftPos + 6, this.topPos + 61, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_alarm_manual.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
			if (true) {
		...
		imagebutton_alarm_manual1 = new ImageButton(this.leftPos + 6, this.topPos + 61, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_alarm_manual1.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
		...
		imagebutton_x3 = new ImageButton(this.leftPos + 7, this.topPos + 62, 16, 16, 0, 0, 16, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_x3.png"), 16, 32, e -> {
		});
		this.addRenderableWidget(imagebutton_x3);
		imagebutton_wrench = new ImageButton(this.leftPos + 24, this.topPos + 43, 18, 18, 0, 0, 18, new ResourceLocation("pixelator:textures/screens/atlas/imagebutton_wrench.png"), 18, 36, e -> {
			int x = CameraViewPropertiesScreen.this.x;
			int y = CameraViewPropertiesScreen.this.y;
			if (AlarmEnabledSettingsProcedure.execute(world, entity)) {
