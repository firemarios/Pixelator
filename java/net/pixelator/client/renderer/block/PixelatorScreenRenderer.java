...
public class PixelatorScreenRenderer implements BlockEntityRenderer<PixelatorScreenBlockEntity> {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer((BlockEntityType<PixelatorScreenBlockEntity>) PixelatorModBlockEntities.PIXELATOR_SCREEN.get(), PixelatorScreenRenderer::new);
	}
