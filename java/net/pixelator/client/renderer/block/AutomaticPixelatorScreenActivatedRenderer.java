...
public class AutomaticPixelatorScreenActivatedRenderer implements BlockEntityRenderer<AutomaticPixelatorScreenActivatedBlockEntity> {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer((BlockEntityType<AutomaticPixelatorScreenActivatedBlockEntity>) PixelatorModBlockEntities.AUTOMATIC_PIXELATOR_SCREEN_ACTIVATED.get(), AutomaticPixelatorScreenActivatedRenderer::new);
	}
