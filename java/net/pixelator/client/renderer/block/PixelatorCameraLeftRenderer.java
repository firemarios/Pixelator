...
public class PixelatorCameraLeftRenderer implements BlockEntityRenderer<PixelatorCameraLeftBlockEntity> {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer((BlockEntityType<PixelatorCameraLeftBlockEntity>) PixelatorModBlockEntities.PIXELATOR_CAMERA_LEFT.get(), PixelatorCameraLeftRenderer::new);
	}
