...
public class PixelatorCameraRightRenderer implements BlockEntityRenderer<PixelatorCameraRightBlockEntity> {
	...
	PixelatorCameraRightRenderer(BlockEntityRendererProvider.Context context) {
	...
	public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		event.registerBlockEntityRenderer((BlockEntityType<PixelatorCameraRightBlockEntity>) PixelatorModBlockEntities.PIXELATOR_CAMERA_RIGHT.get(), PixelatorCameraRightRenderer::new);
	}
	...
	private static final class CustomHierarchicalModel extends Modelpixelator_camera {
		...
		private class BlockEntityHierarchicalModel extends HierarchicalModel<Entity> {
			...
			public void setupBlockEntityAnim(PixelatorCameraRightBlockEntity blockEntity, float ageInTicks) {
				...
				animator.animate(blockEntity.animationState0, pixelator_cameraAnimation.right, ageInTicks, 1f);
