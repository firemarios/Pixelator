...
public class PixelatorModKeyMappings {
	public static final KeyMapping EXIT_CAMERA_VIEW = new KeyMapping("key.pixelator.exit_camera_view", GLFW.GLFW_KEY_LEFT_SHIFT, "key.category.pixelator.gameplay") {
	...
	public static final KeyMapping CAMERA_TURN_LEFT = new KeyMapping("key.pixelator.camera_turn_left", GLFW.GLFW_KEY_A, "key.category.pixelator.gameplay");
	public static final KeyMapping CAMERA_TURN_RIGHT = new KeyMapping("key.pixelator.camera_turn_right", GLFW.GLFW_KEY_D, "key.category.pixelator.gameplay");
	public static final KeyMapping CAMERA_TURN_UP = new KeyMapping("key.pixelator.camera_turn_up", GLFW.GLFW_KEY_W, "key.category.pixelator.gameplay");
	public static final KeyMapping CAMERA_TURN_DOWN = new KeyMapping("key.pixelator.camera_turn_down", GLFW.GLFW_KEY_S, "key.category.pixelator.gameplay");
	public static final KeyMapping CAMERA_PROPERTIES = new KeyMapping("key.pixelator.camera_properties", GLFW.GLFW_KEY_I, "key.category.pixelator.gameplay") {
		private boolean isDownOld = false;
