...
public class PixelatorTeleportCam5BtnPProcedure {
		...
		if (PixelatorModVariables.cameras_decoded.size() >= 6 * entity.getCapability(PixelatorModVariables.PLAYER_VARIABLES).orElseGet(PixelatorModVariables.PlayerVariables::new).teleport_page - 1) {
			{
				...
				if (_playerVars != null) {
					...
					}.getListElement(PixelatorModVariables.cameras_decoded, (int) ((6 * entity.getCapability(PixelatorModVariables.PLAYER_VARIABLES).orElseGet(PixelatorModVariables.PlayerVariables::new).teleport_page - 1) - 1), String.class, ""));
